...
|-|-----------|------------------|---------- |
10-50| Фокин Денис, LRI | *Кунсткамера инструментов для анализа кода от vi до vibe программирования: cовременные проблемы разработчиков инструментов разработчик а* |  |
