...
|-|-----------|------------------|---------- |
9-35| Николай Вячеславович Шилов | *"Теория всего": унификация паттернов дизайна алгоритмов* | |
10-55| Андрей Петрович Немытых | *Известная проблема эффективности операционной семантики Рефала, и её связь со скоростью передачи информации* ||
...
|Начало| Докладчик | Название доклада | Слайды |
|-|-----------|------------------|---------- |
15-00| Никита Олегович Горбатов | *Суперкомпилятор простого функционального языка, анализирующий выходные форматы конфигураций* |  |
...
**Очных мест по предварительной записи осталось: 1** (больше не поместится в аудиторию)
